...
<body class="bg-background-light dark:bg-background-dark text-slate-800 dark:text-slate-200 font-display min-h-screen flex flex-col">
   <div class="h-screen w-full flex flex-col items-center justify-center text-center">
    <img src="assets/img/404.jpg" class="max-w-3xl h-auto mb-4" alt="Page Not Found">

    <a href="/" class="mt-4 p-4 bg-blue-500 rounded text-white hover:underline">Return Home</a>
</div>>
</body>
